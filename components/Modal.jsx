...
export default function Modal() {
  ...
  const [selcetdFile, setSelcetdFile] = useState(null);
  ...
  const uploadPost = async () => {
    ...
    await uploadString(imgRef, selcetdFile, "data_url").then(
      async (snapshot) => {
  ...
  const addImageToPost = (e) => {
    ...
    reader.onload = (readerEvent) => {
      setSelcetdFile(readerEvent.target.result);
    };
  };
  return (
